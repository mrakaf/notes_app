                    ...
                    <div class="text-center mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                            ...
                            <div class="">
                                ...
                                <h3 class="text-xl font-semibold text-white mb-2"></h3>
                        ...
                        <div class="">
                            <div class="text-white mb-4">
                                <svg class="w-8 h-8 mx-auto icon-animate" fill="none"  viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                    ...
                    <form id="noteForm" action="{{ route('notes.store') }}" method="POST">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('notes.index') }}" 
                               class="px-6 py-3 bg-gray-500/30 text-white rounded-xl transition-all duration-300 
                                      hover:bg-gray-500/50 flex items-center gap-2">
